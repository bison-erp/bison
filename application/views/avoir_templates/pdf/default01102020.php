...
<head>
    ...
    <title>
        <?php echo lang('avoir'); ?> n° <?php echo $invoice->invoice_number; ?> sur <?php echo lang('invoice'); ?> n°
        <?php echo $invoice->invoice_number_origin; ?>
        ...
        <tr>
            <td>
                <div id="devis_text" valign="top">
                    ...
                    <?php $output = "./assets/default/img/avoir.jpg";

?>
                    <img style=" width: 18%; margin-top:-25px" src="<?php echo $output; ?>">

                    <!--  <img style=" width: 18%; margin-top:-25px"
                        src="<?php echo site_url('assets/default/img/avoir.jpg'); ?>">
-->
                </div>
            </td>
            <td style=" width:75px "></td>
...
?>
    ...
    <br> <span style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000; font-size: 12">
        <?php echo lang('num/ref') . '&nbsp;:&nbsp;' ?>
        <?php echo lang('avoir') ?>&nbsp;<?php echo $invoice->invoice_number; ?>&nbsp;
        sur <?php echo lang('invoice'); ?>&nbsp;         <?php echo $this->mdl_settings->setting('prefix_invoice') . $invoice->invoice_number_origin; ?>
        <?php echo lang('quote_Du'); ?>
        <?php echo date_from_mysql($invoice->date_create_avoir_invoice, true); ?>
...
?>
    ...
    <p style=" margin-top:20px;font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000;text-align:center">
        <b>
...
if ($dlai != '') {?>
        ...
        <?php   echo lang('CdtsReglement') . ': '; ?> <?php    echo $dlai; ?>
