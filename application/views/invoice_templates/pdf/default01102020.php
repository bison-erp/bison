...
text-align: center;" class="style_th"><?php echo lang('tva_pdf'); ?></th>
                <?php }?>
                <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf') ?>;
 text-align: center;" class="style_th"><?php echo lang('amount'); ?></th>
            </tr>
        </thead>
        <tbody>
            <?php
...
if ($setting == 1) {
    ?>
                            ...
                            <tr style=" display: none" class="amount-total border-top-n">
                                <td style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>;" class="td_backgrounded"><b><?php echo lang('total_amount'); ?> </b></td>
...
if($invoice->langue=="French"){
   ...
   $ress=format_devise($invoice->invoice_balance, $invoice->client_devise_id, 0);
