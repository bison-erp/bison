...
<body>
    ...
    <div id="menu-container">
        ...
        <a href="<?php echo site_url('guest/view/generate_invoice_pdf/' . $invoice_url_key); ?>"
            class="btn btn-primary"><i class="fa fa-print"></i> <?php echo lang('download_pdf'); ?></a>
                ...
                <tr>
                    <td id="company-name">
                        ...
                        <p><?php if ($invoice->user_vat_id) {echo lang("vat_id_short") . ": " . $invoice->user_vat_id . '<br>';}?>
                            ...
                            <?php if ($invoice->user_phone) {?><?php echo lang('phone_abbr'); ?>:
                            <?php echo $invoice->user_phone; ?><br><?php }?>
                            <?php if ($invoice->user_fax) {?><?php echo lang('fax_abbr'); ?>:
                            <?php echo $invoice->user_fax; ?><?php }?>
                        </p>
                    </td>
                    <td class="alignr">
                ...
                <tr>
                    <td>
                        ...
                        <p><?php if ($invoice->client_vat_id) {echo lang("vat_id_short") . ": " . $invoice->client_vat_id . '<br>';}?>
                            ...
                            <?php if ($invoice->client_phone) {?><?php echo lang('phone_abbr'); ?>:
                            <?php echo $invoice->client_phone; ?><br><?php }?>
                        </p>
                    </td>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align:right;">
                                        <?php echo date_from_mysql($invoice->invoice_date_created); ?></td>
                                </tr>
                                <tr>
                                    <td><?php echo lang('due_date'); ?></td>
                                    <td style="text-align:right;">
                                        <?php echo date_from_mysql($invoice->invoice_date_due); ?></td>
                                </tr>
                                <tr>
