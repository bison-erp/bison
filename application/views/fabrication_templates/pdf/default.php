...
?>
    ...
    <span style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000; font-size: 12">
        <?php echo lang('bf'); ?> N°
     <b>   <?php echo $this->mdl_settings->setting('prefix_fabrication') . $fabrication->fabrication_number; ?></b>
        <?php echo lang('quote_Du'); ?>
     <b>   <?php echo date_from_mysql($fabrication->quote_date_created, true); ?></b>
