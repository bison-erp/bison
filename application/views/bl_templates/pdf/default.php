...
<body style="">
 <?php if($bl->display_amount!=0){ ?>
<?php if($bl->langue!="Arabic"){ ?>

    <table style=" width: 100%">
        <?php
         $this->lang->load('ip_', $bl->langue);
...
if ($bl->client_mat_fiscal) {
    ...
    ?>
                ...
                <br><br>
                    <?php 
                    $output ="";
                    if($bl->langue=="English"){
                        $output = "./assets/default/img/logo_txt_bl-en.jpg";
                    }else{
                        $output = "./assets/default/img/logo_txt_bl.jpg";
                    }
    ?>
...
?>
    ...
    <tr>
        ...
        <span style="  font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000; font-size: 12">
            ...
            echo $this->mdl_settings->setting('prefix_bl')?>
                <?php echo  $bl->bl_number;  ?> 
            </b>
            
            <?php echo lang('quote_Du'); ?>
           <b> <?php echo date_from_mysql($bl->quote_date_created, true); ?></b>
...
//var_dump($arrayItems);die('1');
foreach ($arrayItems as $itemsF) {
    if ($itemsF) { 
        ?>
    <table class="table_products" style="color: <?php echo $this->mdl_settings->setting('clr_pdf') ?>
...
; text-align: center;" class="style_th"><?php echo lang('tva_pdf'); ?></th>
                ...
                <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf') ?>
; text-align: center;width: 120px;" class="style_th"><?php echo lang('amount_ttc'); ?></th>
            </tr>
        </thead>
        <?php } else {?>
        <thead>
                ...
                <tr>
                    <td class="text-right">
                        <table class="" style=" width: 250px; font-size:12px;">
                            ...
                            <tr>
                                <th class="text-right" style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>;width: 150px; padding:5px; color:#000000;">
...
if ($setting == 1) {
    ?>
                            ...
                            <tr>
                                <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>" class="td_backgrounded" style="width: 150px;">
                                    Total (DT):</th>
                            ...
                            <?php }}?>
                            <tr style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>; display: none" class="amount-total border-top-n">
...
$rem = (float) $bl->bl_pourcent_acompte;
        ...
        ?> %</th>
                            ...
                            <tr>
                              <!--  <th  style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>" class="td_backgrounded"><?php echo lang('net_to_pay'); ?></th>
                                <th  style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>" class="text-right td_backgrounded">
                             
                                    <?php 
                                  /*  if($bl->bl_total_a_payer){
                                        echo format_devise($bl->bl_total_a_payer, $bl->client_devise_id, 0); 
                                    }else{
                                        echo format_devise($bl->bl_balance, $bl->client_devise_id, 0); 
                                    }*/
                                  ?>
                                </th>-->
                            </tr>
...
if($bl->langue=="French"){
    if($bl->bl_total){  
        $rest = int2str($bl->bl_total, $dev_symb);
    ...
    if($bl->bl_total){  
        $ress=format_devise($bl->bl_total, $bl->client_devise_id, 0);
        $replaced = str_replace(' ', '',$ress);
        $rest = numberTowords($replaced,$dev_symb);
    
    }else{
        $ress=format_devise($bl->bl_total_a_payer, $bl->client_devise_id, 0);
        $replaced = str_replace(' ', '',$ress);
        $rest = numberTowords($replaced,$dev_symb);    
    }
...
?></p>
            ...
            <?php }elseif (trim($bl->bl_terms) != ""){?>
                <p
                style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; font-size: 12px; color: #000; width:100%">
                <?php echo "<b>" . lang('notes') . ":</b> " . $bl->bl_terms; ?></p>
            <?php }?>
        </div>

      
    </div>
    <p style="text-align:right; font-family:Verdana, sans-serif; font-stretch: ultra-expanded; font-size: 12px; color: #000"
           ><?php echo lang('msg_merci'); ?></p>
      ...
      <tr>
          <td>
              <div id="devis_text" valign="top">
                  ...
                  <?php $output = "./assets/default/img/logo_txt_livraison-arabe.jpg";
...
if ($bl->client_titre == 0) {
  ...
  ?>
                  ...
                  <?php echo lang('attention_pdf')  . ' ' ?> <?php echo ($client_titre . ' ' . $bl->client_prenom . ' ' . $bl->client_name ) ; ?>
                  <br/>
...
foreach ($delai as $value) {
  if ($value->delai_paiement_id == $bl->bl_delai_paiement) {
...
<tr>
        ...
        <table style=" width: 36%;" align="left"  >
            <tr>
                ...
                <span style=" font-family: Arial, Arial; font-stretch: ultra-expanded; font-size: 12; color: #000">
                            <?php
                    if ($bl->quote_date_expires != '0000-00-00') {
                    echo $bl->quote_date_expires.' ';  echo lang('quote_expire_le') . ': ' ;
                    }
                    ?>
                </span>
                </td>
    ...
    <td>
            <table style="width: 36%; " align="right"  >
                ...
                <td >
                <span style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000; font-size: 12">
                <?php echo $bl->bl_date_created ;?> <?php echo lang('quote_Du').' '; ?> 
                </span>
                </td>
                <td>
                <span style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000; font-size: 12">
                <?php echo lang('bl').' رقم'; ?> <?php echo $this->mdl_settings->setting('prefix_bl') . $bl->bl_number; ?>
                </span>
                </td>
                </tr>
            </table>
...
;width: 80px;text-align: center;"><?php echo lang('photo') ?></th>
            <?php  } ?>    
            <th class="style_th" style="color: <?php echo $this->mdl_settings->setting('clr_pdf') ?>;
width: 100px;text-align:center"><?php echo lang('item_pdf'); ?></th>
...
" class="text-right">
                                ...
                                <td style="text-align: right;color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>" class=""><b><?php echo lang('tvatotal'); ?> </b>
                                    </td>
                            </tr>
                            <?php } else {?>
...
" class="td_backgrounded" style="width: 150px;">
                                    Total (DT):</th>
                                <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class="text-right td_backgrounded">
                                    <?php echo format_devise($bl->bl_item_subtotal, $bl->client_devise_id, 0); ?>
...
" class=""><b><?php echo lang('timbre_pdf'); ?></b></td>
                            ...
                            <?php }}?>
                            <tr style="text-align: right;color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>; display: none" class="amount-total border-top-n">
                             
                                <td style="text-align: right;color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>;" class="text-right color-d td_backgrounded">
                                    <b><?php echo format_devise($bl->bl_total, $bl->client_devise_id, 0); ?></b>
                                </td>
    ...
    ?>
                        <table class="tables_calculs" border="1" style=" width: 250px">
                            ...
                            <tr>
                                ...
                                <th style="text-align: right;color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>;" class="text-right td_backgrounded">
                                    <?php echo '-' . format_devise($bl->bl_montant_acompte, $bl->client_devise_id, 0); ?>
                                </th>
...
$rem = (float) $bl->bl_pourcent_acompte;
        ...
        ?> </th>
                            ...
                            <tr>
                                ...
                                <th style="text-align: right;color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>;" class="td_backgrounded"><?php echo lang('net_to_pay'); ?></th>
...
if($bl->bl_total_a_payer){  
    $rsss= format_devise($bl->bl_total_a_payer, $bl->client_devise_id, 0);
}else{
   $rsss= format_devise($bl->bl_balance, $bl->client_devise_id, 0);
...
?></p>
    ...
    <div style="width:25%;float:right;position:absolute;bottom:120px">
     ...
     if($this->mdl_settings->setting('signature_logo')){
     if($bl->signature==1){ ?>
       <img style="max-width:100px;max-height:120px;" style="max-width:200px;max-height:120px;" src="<?php echo base_url('uploads/' . strtolower($this->session->userdata('licence')) . '/' . $this->mdl_settings->setting('signature_logo')); ?>">
...
<p style="font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000;text-align:center">
    ...
    <tr>
        ...
        <span style="  font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000; font-size: 12">
            ...
            <?php echo lang('quote_Du'); ?><b>
            <?php echo date_from_mysql($bl->quote_date_created, true); ?></b>
            <?php echo lang('quote_par'); ?>
            <?php
    if ($bl->user_code != '') {
        echo $bl->user_code;
...
<table dir="rtl" class="table_products" style="width: 100%;margin-top:20px">
    ...
    <thead>
        <tr class="border-bottom-d tr_color">
        <?php if($bl->photo==1){ ?>
                <th class="style_th" style="text-align:center;color: <?php echo $this->mdl_settings->setting('clr_pdf') ?>
;width: 80px;text-align: center;"><?php echo lang('photo') ?></th>
            <?php  } ?>    
            <th class="style_th" style="text-align:center;color: <?php echo $this->mdl_settings->setting('clr_pdf') ?>;
