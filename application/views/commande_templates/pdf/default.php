...
<?php if($commande->langue!="Arabic"){ 
      $this->lang->load('ip_', $commande->langue);
        ...
        <tr>
            ...
            <td valign="bottom" style=" width:315px ">
                <br><span style="font-size: 13; color:#333">
                    <b style="color:#000"><?php echo $commande->client_societe; ?></b><br>
                    <?php
if ($commande->client_titre == 0) {
        $client_titre = "M.";
    } elseif ($commande->client_titre == 1) {
        $client_titre = "Mme.";
    } elseif ($commande->client_titre == 2) {
        $client_titre = "Mlle.";
    }
    ?>

                    <?php echo lang('attention_pdf') . ' ' . $client_titre . ' ' . $commande->client_name . ' ' . $commande->client_prenom . '<br/>'; ?>


                    <?php
if ($commande->client_address_1) {
        echo $commande->client_address_1 . '<br/>';
    }
    ?>
                    <?php
if ($commande->client_address_2) {
        echo $commande->client_address_2 . '<br/>';
    }
    ?>
                    <?php
if ($commande->client_zip) {
        echo $commande->client_zip . ' ';
    }
    ?>
                    <?php
if ($commande->client_city) {
        echo $commande->client_city . '<br/> ';
    }
    ?>

                    <?php
if ($commande->client_state) {
        echo $commande->client_state . '&nbsp;';
    }
    if ($commande->client_country) {
        echo $countries[$commande->client_country] . '<br/>';
    }
    if ($commande->client_phone) {
        echo lang('phone') . ': ' . $commande->client_phone;
        if ($commande->client_mobile) {
            echo " - " . $commande->client_mobile;
        }
        echo '<br/>';
    }
    ?>
                    ...
                    <?php
if ($commande->client_tax_code) {
        echo lang('registre_commerce_pdf') . ': ' . $commande->client_tax_code . '<br/>';
    }
    ?>
                    <?php
if ($commande->client_mat_fiscal) {
        echo lang('matricule_fisc_pdf') . ': ' . $commande->client_mat_fiscal . '<br/>';
    }
    ?>
                ...
                <div id="devis_text" valign="top">
                    <?php 
                      $output ="";
                      if($commande->langue=="English"){
                          $output = "./assets/default/img/logo_txt_commande-en.jpg";
                      }else{
                          $output = "./assets/default/img/logo_txt_commande.jpg";
                      }
    ?>
                    <img style=" width: 22%; margin-top: 35px" src="<?php echo $output; ?>">
...
<div id="devis_text" valign="top">
    <!--<img style="margin-left: 0px; width: 18%; margin-top:-25px"
        src="<?php echo site_url('assets/default/img/logo_txt_commande.jpg'); ?>">
        --><?php
         $output ="";
         if($commande->langue=="English"){
             $output = "./assets/default/img/logo_txt_commande-en.jpg";
...
?>
    ...
    <p style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000;text-align:center">
        <b>
            <?php echo $commande->commande_nature; ?>
        </b>
    </p>
    ...
    <span style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000; font-size: 12">
      ...
      <b>  <?php echo $this->mdl_settings->setting('prefix_commande') . $commande->commande_number; ?></b>
        <?php echo lang('quote_Du'); ?>
      <b>  <?php echo date_from_mysql($commande->quote_date_created, true); ?></b>
        <?php echo lang('quote_par'); ?>
        <?php
if ($commande->user_code != '') {
    echo $commande->user_code;
} else {
    echo $commande->user_name;
}
?>
    </span>
    </td>
    ...
    <span style="font-family: Arial, Arial; font-stretch: ultra-expanded; font-size: 12; color: #000">
        ...
        <?php
if ($commande->quote_date_expires != '0000-00-00') {
    echo '&nbsp;&nbsp;' . lang('quote_expire_le');
    ?> : <?php
echo date_from_mysql($commande->quote_date_expires, true);
}
?>
    </span>
    </td>
...
foreach ($devises as $value) {
    if ($commande->client_devise_id == $value->devise_id) {
    ...
    <table class="table_products" style="width: 100%;margin-top:20px">
        ...
        <thead>
            ...
            <?php  } ?>    
                ...
                <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf') ?>; text-align: center;width: 120px;" class="style_th"><?php echo lang('amount_ttc'); ?></th>
            </tr>
        </thead>
        <?php } else {?>
        <thead>
        ...
        foreach ($itemsF as $item) {
            ...
            <?php if($commande->photo==1){         
                ...
                <td class="text-right" style="font-size:11px; border-color: #888;">
                    <?php echo format_devise($item->item_price, $commande->client_devise_id); ?></td>

                <td class="text-right" style="font-size:11px; border-color: #888;">
                    <?php echo format_amount($item->tax_rate_percent); ?></td>

                <td class="text-right" style="font-size:11px; border-color: #888;">
                    <?php echo format_devise($item->item_total, $commande->client_devise_id); ?></td>
            </tr>
    ...
    <div>
        ...
        <div style="float:right">
            <table>
                <tr>
                    <td class="text-right">
                        <table class="" style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
;width: 250px; font-size:12px;">
                            <?php if ($commande->commande_pourcent_remise != 0) {?>
                            <tr>
                                <th class="text-right" style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
;width: 150px; padding:5px;">
                                    <?php echo lang('remise_pdf'); ?> <?php
$rem = (float) $commande->commande_pourcent_remise;
    echo $rem;
    ?> %</th>
                                <th class="text-right td_backgrounded" style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
;border:#5e5e5e solid 1px; padding:5px;">
                                    <?php echo '-' . format_devise($commande->commande_montant_remise, $commande->client_devise_id, 0); ?>
                                </th>
                            </tr>
                            <?php }?>
                        </table>
...
if ($setting == 1) {
    ?>
                            <tr>
                                <th class="td_backgrounded" style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
width: 150px;"><?php echo lang('total_pdf'); ?>
                                ...
                                <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>" class="text-right td_backgrounded">
                                    <?php echo format_devise($commande->commande_item_subtotal, $commande->client_devise_id, 0); ?>
                                </th>
                            </tr>
                            <tr>
                                <td style ="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class=""><?php //echo lang('total_pdf'); ?> <?php ////echo $dev_symb; ?>
                                    <?php echo lang('tva_pdf2'); ?>:</td>
                                <td style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class="text-right">
                                    <?php echo format_devise($commande->commande_item_tax_total, $commande->client_devise_id, 0); ?>
                                </td>
                            </tr>
                            <?php } else {?>
                            ...
                            <?php if ($commande->timbre_fiscale != 0) {?>

                            <tr>
                                <td style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class=""><?php echo lang('timbre_pdf'); ?></td>
                                <td style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class="text-right ">
                                    <?php echo format_devise($commande->timbre_fiscale, $commande->client_devise_id, 0); ?>
                                </td>
                            </tr>
                            ...
                            <tr style=" display: none" class="amount-total border-top-n">
                                <td style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class="td_backgrounded"><b><?php echo lang('amount_ttc'); ?> <?php ////echo $dev_symb; ?>
                                        <?php // echo lang('ttc'); ?>:</b></td>
                                <td style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class="text-right color-d td_backgrounded">
                                    <b><?php echo format_devise($commande->commande_total, $commande->client_devise_id, 0); ?></b>
                                </td>
                            </tr>
                        </table>
                        <br>
...
if ($setting == 1) {
    ?>
                        <table class="tables_calculs" border="1" style=" width: 250px">
                            ...
                            <?php if ($commande->commande_pourcent_acompte != 0) {?>

                            <tr>
                                <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class="td_backgrounded"><?php echo lang('acompte_pdf'); ?> <?php
$rem = (float) $commande->commande_pourcent_acompte;
        echo $rem;
        ?> %</th>
                                <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class="text-right td_backgrounded">
                                    <?php echo '-' . format_devise($commande->commande_montant_acompte, $commande->client_devise_id, 0); ?>
                                </th>
                            </tr>
                            <tr>
                                <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class="td_backgrounded"><?php echo lang('rest_pdf') ?></th>
                                <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class="text-right td_backgrounded">
                                    <?php echo format_devise($commande->commande_total_a_payer, $commande->client_devise_id, 0); ?>
                                </th>
                            </tr>
                            <?php } else {?>
...
" class="text-right td_backgrounded">
        ...
        <div style="width:25%;position:absolute;bottom:60px"> <br>
            <p class=""
                style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; font-size: 12px; color: #000; width:100%">
                <?php echo lang('msg_arret_commande'); ?>
                <?php
//echo
$rest ="";
$this->load->helper('numbertowords');

if($commande->langue=="French"){
   $rest = int2str($commande->commande_total_a_payer,$dev_symb);
}else{
    $ress = format_devise($commande->commande_total_a_payer, $commande->client_devise_id, 0);
...
?></p>
            ...
            <?php if (trim($commande->notes) != "") {?>
            <p
                style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; font-size: 12px; color: #000; width:100%">
                <?php echo "<b>" . lang('notes') . ":</b> " . $commande->notes; ?></p>
            <?php }?>
        </div>
      ...
      <tr>
          <td>
              <div id="devis_text" valign="top">
                  ...
                  <?php $output = "./assets/default/img/logo_txt_commande-arabe.jpg";
...
if ($commande->client_titre == 0) {
  ...
  ?>
                  ...
                  <?php echo lang('attention_pdf')  . ' ' ?> <?php echo ($client_titre . ' ' . $commande->client_prenom . ' ' . $commande->client_name ) ; ?>
                  <br/>
...
foreach ($delai as $value) {
  if ($value->delai_paiement_id == $commande->commande_delai_paiement) {
        ...
        <table style=" width: 36%;" align="left"  >
            <tr>
                ...
                <span style=" font-family: Arial, Arial; font-stretch: ultra-expanded; font-size: 12; color: #000">
                            <?php
                    if ($commande->quote_date_expires != '0000-00-00') {
                    echo $commande->quote_date_expires.' ';  echo lang('quote_expire_le') . ': ' ;
                    }
                    ?>
                </span>
                </td>
        ...
        <td>
         ...
         <td>
            <table style="width: 36%; " align="right"  >
                ...
                <td >
                <span style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000; font-size: 12">
                <?php echo $commande->commande_date_created ;?> <?php echo lang('quote_Du').' '; ?> 
                </span>
                </td>
                <td>
                <span style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000; font-size: 12">
                <?php echo lang('commande').' رقم'; ?> <?php echo $this->mdl_settings->setting('prefix_commande') . $commande->commande_number; ?>
                </span>
                </td>
                </tr>
            </table>
...
; text-align: center;" class="style_th"><?php echo lang('qte_pdf'); ?></th>
              <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf') ?>
; text-align: center;width: 120px" class="style_th"><?php echo lang('price_pdf'); ?></th>
           <!--   <th style=" text-align: center;" class="style_th"><?php //echo lang('tva_pdf'); ?></th>-->

              <th style="color: <?php echo $this->mdl_settings->setting('clr_pdf') ?>
; text-align: center;width: 120px;" class="style_th"><?php echo lang('total_pdf'); ?></th>
          </tr>
      </thead>
      <?php } else {?>
      <thead>
...
; text-align: center;" class="style_th"><?php echo lang('qte_pdf'); ?></th>
              <th style=" color: <?php echo $this->mdl_settings->setting('clr_pdf') ?>
;text-align: center;width: 120px" class="style_th">PU</th>
...
?>
  <div>
      <!--zone de droite-->
      <div style="font-family: Arial; width:40%;color:#000;float:left; margin-top: 0px">
          <div style="font-family: Arial; border:1px solid #000;font-size:10px; padding:10px;text-align:right">
              <?php echo lang('bon_accord_pdf'); ?>
              <div style="margin-top:100px;font-size:10px"><?php echo lang('signature_pdf'); ?></div>
          </div>
                  ...
                  <td class="text-right">
                      <table class="" style="width: 250px; font-size:12px;">
                          ...
                          <tr>
                              ...
                              <th class="text-right td_backgrounded" style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
;border:#5e5e5e solid 1px; padding:5px;text-align:right">
                                  <?php echo '-' . format_devise($commande->commande_montant_remise, $commande->client_devise_id, 0); ?>
                              </th>
                              <th class="text-right" style="color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>;width: 150px; padding:5px;text-align:right">
                                  <?php echo lang('remise_pdf'); ?>% <?php
$rem = (float) $commande->commande_pourcent_remise;
  echo $rem;
  ?> </th>
...
if ($setting == 1) {
  ?>
                          <tr>
                              ...
                              <th class="text-right td_backgrounded " style="text-align:right;color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
">
...
" class="text-right">
                              ...
                              <td style="text-align:right;color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class=""> 
                               <b>   <?php echo lang('tvatotal'); ?></b></td>
                          </tr>
                          <?php } else {?>
...
" class="text-right ">
                              ...
                              <td style="text-align:right;color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class=""><b><?php echo lang('timbre_pdf'); ?></b></td>
                          </tr>
                          ...
                          <tr style=" display: none" class="amount-total border-top-n">
                              ...
                              <td style=" text-align:right;color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>" class="td_backgrounded"><b> 
                                <?php echo lang('ttc'); ?></b></td>
                          </tr>
                      </table>
                      <br>
...
" class="text-right td_backgrounded">
                              ...
                              <th style=" text-align:right;color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class="td_backgrounded"><?php echo lang('acompte_pdf'); ?>% <?php
$rem = (float) $commande->commande_pourcent_acompte;
      echo $rem;
      ?> </th>
...
" class="text-right td_backgrounded">
                              ...
                              <th style=" text-align:right;color: <?php echo $this->mdl_settings->setting('clr_pdf_somme') ?>
" class="td_backgrounded"><?php echo lang('net_to_pay'); ?></th>
                          </tr>
                          <?php }?>
                      </table>
                      <?php } else {?>
      ...
      <div style="width:100%;float:right;margin-right:-900px">
          ...
          <p class=""
              ...
              <?php
//echo
$rsss= format_devise($commande->commande_total_a_payer, $quote->client_devise_id, 0);
