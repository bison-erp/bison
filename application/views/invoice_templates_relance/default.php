        ...
        <tr>
            ...
            <td style=" width:300px ">
                <div id="logo"><img style="max-width:200px;max-height:100px;"
                        src="<?php echo base_url('uploads/' . $licence . '/' . $settval); ?>">
                </div>
...
?>
                    <i><?php
echo '&nbsp;' . $lang['attention_pdf'] . ' ' . $client_titre . ' ' . $invoice->client_name . ' ' . $invoice->client_prenom . '<br/>'; ?></i>
...
?>
    ...
    <br> <span style=" font-family:Verdana, sans-serif; font-stretch: ultra-expanded; color: #000; font-size: 12">
        ...
        <?php
echo $this->mdl_settings->setting('prefix_invoice') . $invoice->invoice_number; ?>
...
function formatdevisere($db, $amount, $devise_id, $display_symbol = 1)
            ...
            echo formatdevisere($db, $item->item_price, $invoice->client_devise_id);?></td>
                <?php
if ($setting == 1) {
                ?>
                <td class="text-right" style="font-size:11px; border-color: #888;">
                ...
                <td class="text-right" style="font-size:11px; border-color: #888;">
                    <?php
echo formatdevisere($db, $item->item_total, $invoice->client_devise_id);
            ?></td>
            </tr>
            <?php $linecounter++;?>
            <?php }?>
...
$rem = (float) $invoice->invoice_pourcent_remise;
    ...
    ?> %</th>
                                <th class="text-right td_backgrounded" style="border:#5e5e5e solid 1px; padding:5px;">
                                    <?php echo '-' . formatdevisere($db, $invoice->invoice_montant_remise, $invoice->client_devise_id, 0); ?>
                                </th>
                            </tr>
                            <?php }?>
                        </table>
...
if ($setting == 1) {
    ...
    echo formatdevisere($db, $invoice->invoice_item_subtotal, $invoice->client_devise_id, 0); ?>
                                </th>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right"><b>
                                        <?php echo formatdevisere($db, $invoice->invoice_item_tax_total, $invoice->client_devise_id, 0); ?>
                                    </b>
                                </td>
                            </tr>
                            <?php } else {?>
                            <tr>
                                <th class="td_backgrounded" style="width: 150px;">
                                    Total (DT):</th>
                                <th class="text-right td_backgrounded">
                                    <?php echo formatdevisere($db, $invoice->invoice_item_subtotal, $invoice->client_devise_id, 0); ?>
                                </th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right "><b>
                                        <?php echo formatdevisere($db, $invoice->timbre_fiscale, $invoice->client_devise_id, 0); ?>
                                    </b>
                                </td>
                            </tr>
                            ...
                            <tr style=" display: none" class="amount-total border-top-n">
                                ...
                                <td class="text-right color-d td_backgrounded">
                                    <b><?php echo formatdevisere($db, $invoice->invoice_total, $invoice->client_devise_id, 0); ?></b>
                                </td>
                            </tr>
                        </table>
                        <br>
...
$rem = (float) $invoice->invoice_pourcent_acompte;
        ...
        ?> %</th>
                                <th class="text-right td_backgrounded">
                                    <?php echo '-' . formatdevisere($db, $invoice->invoice_montant_acompte, $invoice->client_devise_id, 0); ?>
                                </th>
                            </tr>
                            <tr>
                                <th class="td_backgrounded">Reste à payer</th>
                                <th class="text-right td_backgrounded">
                                    <?php echo formatdevisere($db, $invoice->invoice_balance, $invoice->client_devise_id, 0); ?>
                                </th>
                            </tr>
                            <?php } else {?>
                            <tr>
