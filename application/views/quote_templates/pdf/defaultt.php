...
function numtoarb ($totall,$dev_symb)
{      
        ...
        <tr>
            <td>
                <div id="devis_text" valign="top">
                    <?php $output = "./assets/default/img/logo_novatis_text.jpg";
...
$rem = (float) $quote->quote_pourcent_acompte;
        ...
        ?> %</th>
                            ...
                            <tr>
                                <th class="td_backgrounded"><?php echo lang('left_to_pay')?></th>
                                <th class="text-right td_backgrounded">
...
?></p>
    ...
    <div style="width:25%; margin-top: 19%">
    <br>
     <?php
...
?>
        <br />
        <?php
if ($quote->quote_date_due != '0000-00-00') {
    echo $quote->quote_date_due.' ';  echo lang('quote_expire_le') . ': ' ;
}
?>
    </span>
         <?php
    ...
    <table class="table_products" style="width: 100%;margin-top:20px">
        ...
        <thead>
            <tr class="border-bottom-d tr_color">
                ...
                <th style=" text-align: center;width: 120px;" class="style_th"><?php echo lang('total_pdf_th'); ?></th>
            </tr>
        </thead>
        <?php } else {?>
        <thead>
...
$rem = (float) $quote->quote_pourcent_acompte;
        ...
        <div style="width:50%;float:left;">
            ...
            <p class=""
                ...
                <?php
//echo
//$quote->quote_total_a_payer
$ch1= numtoarb($quote->quote_total_a_payer,$dev_symb);
$ch2= numtoarbapresvergule(98.00,$dev_symb);
echo  $ch2;
