...
<script type="text/javascript">
    $(function () {
        ...
        $('#quote_to_bl_confirm').click(function () {
            $.post("<?php echo site_url('fabrication/ajax/fabrication_to_bl'); ?>", {
                quote_id: <?php echo $fabrication_id; ?>,
                ...
                fabrication_date_accepte : $('#fabrication_date_accepte').val(),
    ...
    <form class="modal-content">
        <div class="modal-header" style=" height: 50px !important;border-bottom: 1px solid #E5E5E5;width: 41%;">
            ...
            <div class="col-md-10" style=" font-weight: 600;font-size: 18px;margin-bottom: 14px;">
                <?php echo lang('fabrication_to_bl'); ?>
            </div>
        </div>
        <div class="modal-body" style="margin-top: 7%;">
            ...
            <input type="hidden" name="quote_number" id="quote_number" value="<?php echo $quote->fabrication_number; ?>">
            <input type="hidden" name="user_id" id="user_id" value="<?php echo $quote->user_id; ?>">
            <input type="hidden" name="invoice_terms" id="invoice_terms" value="<?php echo $quote->notes; ?> (créer à partir du fabrication n°: <?php echo $quote->fabrication_number; ?>)">
            <input type="hidden" name="nature" id="nature" value="<?php echo $quote->fabrication_nature; ?>">
            <input type="hidden" name="invoice_delai_paiement" id="invoice_delai_paiement" value="<?php echo $quote->fabrication_delai_paiement; ?>">
            <input type="hidden" name="bl_pdf" id="bl_pdf" value=" sur fabrication n°: <?php echo $quote->fabrication_number; ?>">

            <input type="hidden" name="invoice_group_id" id="invoice_group_id" value="0">
            <input type="hidden" name="invoice_status_id" id="invoice_status_id" value="<?php echo $quote->fabrication_status_id; ?>">
            ...
            <input type="hidden" name="fabrication_date_accepte" id="fabrication_date_accepte" value="<?php echo $quote->fabrication_date_accepte; ?>">

            <input type="hidden" name="invoice_item_subtotal" id="invoice_item_subtotal" value="<?php echo $quote->fabrication_item_subtotal; ?>">
            <input type="hidden" name="invoice_item_tax_total" id="invoice_item_tax_total" value="<?php echo $quote->fabrication_item_tax_total; ?>">
            <input type="hidden" name="invoice_tax_total" id="invoice_tax_total" value="<?php echo $quote->fabrication_tax_total; ?>">
            <input type="hidden" name="timbre_fiscale" id="timbre_fiscale" value="<?php echo $quote->timbre_fiscale; ?>">
            <input type="hidden" name="invoice_total" id="invoice_total" value="<?php echo $quote->fabrication_total; ?>">
            <input type="hidden" name="invoice_pourcent_remise" id="invoice_pourcent_remise" value="<?php echo $quote->fabrication_pourcent_remise; ?>">
            <input type="hidden" name="invoice_montant_remise" id="invoice_montant_remise" value="<?php echo $quote->fabrication_montant_remise; ?>">
            <input type="hidden" name="invoice_pourcent_acompte" id="invoice_pourcent_acompte" value="<?php echo $quote->fabrication_pourcent_acompte; ?>">
            <input type="hidden" name="invoice_montant_acompte" id="invoice_montant_acompte" value="<?php echo $quote->fabrication_montant_acompte; ?>">
            <input type="hidden" name="invoice_item_subtotal_final" id="invoice_item_subtotal_final" value="<?php echo $quote->fabrication_item_subtotal_final; ?>">
            <input type="hidden" name="invoice_item_tax_total_final" id="invoice_item_tax_total_final" value="<?php echo $quote->fabrication_item_tax_total_final; ?>">
            <input type="hidden" name="invoice_total_final" id="invoice_total_final" value="<?php echo $quote->fabrication_total_final; ?>">
            <input type="hidden" name="invoice_total_a_payer" id="invoice_total_a_payer" value="<?php echo $quote->fabrication_total_a_payer; ?>">
            <div  class="row">
                ...
                <div  class="col-md-6">
                    ...
                    <div class="form-group form-md-line-input has-info">
                        <div class="quote-properties has-feedback">
                                <label for="form_control_1"  style="font-size: 13px; color: #899a9a;" ><?php echo lang('bl_date'); ?></label>
