...
?>
     <table style="width:100%; margin-top: 0;">
         <tr>
             <td align="right" class="form-widh bf" style="width:25%">
                 ...
                 <form class="navbar-form navbar-left search_in_list" role="search" style="padding:0;">
                     <div class="form-group">
                         <input id="filter_quotes" type="text" class="search-query form-control input-sm" placeholder="<?php echo lang('filter_fabricate'); ?>">
                     </div>
                 </form>
                 <?php }?>
...
<!--
                 <select class="form-control select_filter" id="select_filter_statuts"
                     style=" width:150px;height: 25px;padding: 0px;padding-left: 6px;">
...
-->
             ...
             <td align="right" class="pull-block" style=" width:49%">
...
--> 
                  ...
                  <!--   <button style="padding: 3px 10px 5px; background-color: #2EB2E6; color: #fff;" id="export_excel"
                     ...
                     <a class="create-quote btn btn-sm btn-primary no-marg btn-light-success"
                         href="<?php echo base_url(); ?>fabrication/form">
                         <?php echo lang('create_bf'); ?>
                     </a>
                     <?php }?>
                 </div>
                 <?php }?>
             ...
             <div id="content" class="table-content">
                 ...
                 <div class="table-responsive">
                     <table class="table table-striped" id="quote_all">
                         <thead>
                             <tr>
                                 <th width="50" order="ip_fabrication.fabrication_number"><?php echo lang('num_devis'); ?></th>
                                 
                                 <th width="100" order="ip_fabrication.quote_date_created"><?php echo lang('created'); ?>
                                 </th>
                                 <th width="100" order="ip_fabrication.quote_date_expires"><?php echo lang('due_date'); ?>
                                 </th>
                                 <th width="250" order="client_societe2"><?php echo lang('client_filter'); ?></th>
                                 <th width="70" order="client_country"><?php echo lang('client_pays'); ?></th>
                                 <th width="180" order="ip_fabrication.fabrication_nature"><?php echo lang('quote_nature'); ?></th>
                                <!-- <th width="150" order="fabrication_item_subtotal_final"><?php echo lang('amount_ht'); ?></th>
                                 <th width="150" order="fabrication_total_final"><?php echo lang('amount_ttc'); ?></th>
                              <th width="50" order="ABS(delai_paiement_label)"><?php echo lang('mode_pmt'); ?></th>
                                  --> 
                                <th width="370" order="user_name"><?php echo lang('suivi'); ?></th>
                                 <th width="50"></th>
                                <!-- <th width="50">
...
$('#export_excel').click(function() {
    ...
    if (long1.length > 0) {
        ...
        $.post("<?php echo site_url('fabrication/ajax/getAllfabrication'); ?>", function(data) {
...
$(function() {
    ...
    limit_par_page = 20;
    nb_pages = 1;
    order_by = "ip_fabrication.fabrication_number";
    order_method = "desc";
    ...
    function filterQuotes() {
        ...
        $('#filter_results').load("<?php echo site_url('fabrication/ajax/load_fabrication_partial_filter'); ?>/" +
            Math
