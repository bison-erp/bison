...
<div id="headerbar-index">
	...
	<div class="portlet light profile no-shabow bg-light-blue">
		<div class="portlet-header">
			<div class="portlet-title align-items-start flex-column" style="padding-top: 10px;">
				<div class="caption font-dark-sunglo">
					<span class="caption-subject bold med-caption dark"><?php echo lang('bf'); ?></span><br />
					<span class="caption-subject text-bold small-caption muted"><?php echo lang('create_bf'); ?></span>
				</div>
			</div>
			<div class="portlet-toolbar">
				<a class="btn btn-success btn-sm blue bg-success text-success" id="btn_save_fabrication">
					<?php echo lang('save'); ?>
				</a>
			</div>
		</div>
		<div class="portlet-body stock">
					...
					<div class="row card-row form-row">
						<div class="col-lg-12 col-sm-12 col-xl-12 col-langue">
                            <div class="form-group select-search-input has-info col-input-before-langue">
                                <label class="form_control_1"><?php echo lang('client_name'); ?><span class="text-danger">*</span></label>
								<input style="width: 100%;" id="client_name" class="form-control form-control-lg form-control-light form-width-input client_name" readonly="readonly" value=" ">
                       ...
                       <div class="row card-row form-row">
							<div class="col-lg-12 col-sm-12 col-xl-12">
								<div class="form-group has-info">
									...
									<input class="form-control form-control-md form-control-light" id="client_societe" readonly="readonly" value=" ">
									<div class="form-control-focus"></div>
								</div>
							</div>
						</div>
                    <div class="row card-row form-row">
                        <div class="col-lg-8 col-sm-8 col-xs-12">
                            <div class="form-group has-info">
                                ...
                                <input class="form-control form-control-md form-control-light" id="client_address" readonly="readonly" value=" ">
                                <div class="form-control-focus"></div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-4 col-xs-12">
                            <div class="form-group has-info">
                                ...
                                <input class="form-control form-control-md form-control-light" id="client_pays" readonly="readonly" value=" ">
								<div class="form-control-focus"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row card-row form-row">
                        <div class="col-lg-8 col-sm-8 col-xs-12">
                            <div class="form-group has-info">
                                ...
                                <input class="form-control" id="vat_id" readonly="readonly" value=" ">
                                <div class="form-control-focus"></div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-4 col-xs-12">
                            <div class="form-group has-info">
                                ...
                                <input class="form-control" id="tax_code" readonly="readonly" value=" ">
                                <div class="form-control-focus"></div>
                            </div>
                        </div>
                    </div>
			...
			<!-- fin contact-->
            <!-- AJOUT bon fabriation -->
                    <div class="col-md-6">
						<div class="portlet light formulaire no-padding">
							<div class="content-heading">
								<div class="portlet-title left-title">
									<div class="caption font-dark-sunglo">
										<span class="caption-subject bold med-caption dark"><?php echo lang('bf_order'); ?></span>
									</div>
								</div>
							</div>
					<!--  facture devis -->
					<div class="row card-row form-row">
						<div class="col-lg-6 col-sm-6 col-xs-12">
                            <div class="form-group has-info">
                                ...
                                <input disabled="disabled" id="quote_number" class="form-control form-control-md form-control-light"
                                    value="<?php echo $nextcode; ?>" title="fabrication ">
                                <div class="form-control-focus"></div>
						...
						<div class="col-lg-6 col-sm-6 col-xs-12">
                            <div class="form-group has-info">
								...
								<a href="javascript:;" class="btn btn-secondary btn-light-dark btn-popover" data-container="body" data-toggle="popover" data-content="<?php echo lang('info_nature'); ?>"></a>	
                                <input disabled="disabled" id="quote_nature" class="form-control form-control-md form-control-light" value="">
                                <div class="form-control-focus"></div>
                            </div>
                        </div>
					</div>
                                ...
                                <div class="quote-properties has-feedback">
                                    ...
                                    <div class="input-group">
                                        <input name="quote_date_expires" id="quote_date_expires" disabled="disabled"
                                            class="form-control form-control-md form-control-light datepicker" value=" ">
                                        <span class="input-group-addon">
                                            <i class="fa fa-calendar fa-fw"></i>
                                        </span>
                                    </div>
                                ...
                                <div class="quote-properties has-feedback">
                                    ...
                                    <div class="input-group">
                                        <input name="quote_date_accepte" id="quote_date_accepte" title="Accepté le"
                                            class="form-control form-control-md form-control-light datepicker" value="" disabled="disabled">
                                        <span class="input-group-addon">
                                            <i class="fa fa-calendar fa-fw"></i>
                                        </span>
                                    </div>
					...
					<div class="row card-row form-row">						
                        <div class="col-lg-6 col-sm-6 col-xs-12" style="visibility:hidden">
                            <div class="form-group has-info">
                        ...
                        <div class="col-lg-6 col-sm-6 col-xs-12" style="visibility:hidden">
                            <div class="form-group has-info">
                                ...
                                <select name="quote_status_id" id="quote_status_id"
                                    title="<?php echo lang('status'); ?>" style="padding: 0px 0px;"
                                    class="form-control form-control-md form-control-light">
					...
					<div class="portlet light profile no-shabow bg-light-blue">
						...
						<div class="portlet-body">
							...
							<div class="form-group form-md-line-input has-info">
								...
								<textarea height="40" name="notes" id="notes" style="width: 100%;padding: 5px 10px;" class="form-control form-control-light"></textarea>
								<div class="form-control-focus"></div>
							</div>
							<div style="clear:both"></div>
						</div>
...
<input type="hidden" id="path_dir" value="<?php echo base_url() ?>uploads/<?php echo strtolower($this->session->userdata['licence']) ?>/fileproduct/">
...
function addRow(items) {
    ...
    if ($('#assigite_tva').val() == 1) {
        $.post("<?php echo site_url('tax_rates/ajax/getTaxRate'); ?>", function(data) {
            ...
            var dir_path = $('#path_dir').val()+ file_name;
             row_add += '<td align="center" style="width: 25px;"><i class="fa fa-arrows cursor-move"></i></td>';
         /* row_add += '<td align="center" style="width: 200px;"> <img  height="100" width="200" src="'+dir_path+'"></td>';
          */
...
$('#btn_save_fabrication, #btn_save_quote2').click(function() {
    var items = [];
    var item_order = 1;
    ...
    $.post("<?php echo site_url('fabrication/ajax/create'); ?>", {
