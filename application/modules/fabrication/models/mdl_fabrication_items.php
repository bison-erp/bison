...
class Mdl_fabrication_Items extends Response_Model
{
    public $table = 'ip_fabrication_items';
    public $primary_key = 'ip_fabrication_items.item_id';
    public $date_created_field = 'item_date_added';

    public function default_select()
    {
        $this->db->select('ip_fabrication_item_amounts.*, ip_fabrication_items.*, item_tax_rates.tax_rate_percent AS item_tax_rate_percent');
    }

    public function default_order_by()
    {
        $this->db->order_by('ip_fabrication_items.item_order');
    }

    public function default_join()
    {
        $this->db->join('ip_fabrication_item_amounts', 'ip_fabrication_item_amounts.item_id = ip_fabrication_items.item_id', 'left');
        $this->db->join('ip_tax_rates AS item_tax_rates', 'item_tax_rates.tax_rate_id = ip_fabrication_items.item_tax_rate_id', 'left');
    }
