...
class cronrappelautomatique extends Base_Controller
{
    ...
    public function send_mail1($db, $tab, $taille)
    {
        ...
        if ($taille > 0) {
            ...
            $fullname = "";
            $message = '<html><head><meta http-equiv="Content-Type" content="text/plain; charset=UTF-8"></head><body>';
            $subject = "";
            $to = "";
            $civilite[0] = "M.";
            $civilite[1] = "Mme.";
            ...
            if ($tab[$taille - 1]['type'] == 'i') {
                ...
                $idinsert = $this->db->insert_id();
                 ...
                 $url="https://erp.bison.tn/cron/cronrappelautomatique/savevu/1/bi_".$licence[1]."/". $idinsert;

               // $url = "http://erp-bison.novatis.org/cron/cronrappelautomatique/savevu/1/" . $db . "/" . $idinsert;
                ...
                $idinsert = $this->db->insert_id();
                $newphrase = str_replace($charray, $charrayreplace, $aa[0]->email_template_body);
                $url="https://erp.bison.tn/cron/cronrappelautomatique/savevu/0/bi_".$licence[1]."/". $idinsert;
              // $url = "http://erp-bison.novatis.org/cron/cronrappelautomatique/savevu/0/" . $db . "/" . $idinsert;
