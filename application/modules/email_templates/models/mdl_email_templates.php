...
class Mdl_Email_Templates extends Response_Model
{
    ...
    public function searchinsertclient($id)
    {
        $icli = $this->db->select('insertclient')->where('email_template_id', $id);
        $icli = $this->db->get('ip_email_templates')->result();
        return $icli;
    }
    public function validation_rules()
    {
        return array(
            ...
            'email_template_id_prop' => array(
                'field' => 'email_template_id_prop',
                'label' => lang('title'),
                'rules' => '',
            ),
