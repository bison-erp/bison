                    ...
                    <div class="row card-row form-row">
                        <div class="col-sm-4">
                            <div class="form-group has-info">
                                <label for="form_control_1"><?php echo lang('bons_commande'); ?></label>
					...
					<div class="col-md-12">
						<div class="portlet light formulaire">
                            ...
                            <div class="form-group has-info">
                                ...
                                <textarea height="40" name="notes" id="notes" style="width: 100%;padding: 5px 10px;" class="form-control form-control-lg form-control-light"><?php echo $quote->notes; ?></textarea>
                                <div class="form-control-focus"></div>
                            </div>
                            <div style="clear:both"></div>
                        </div>
