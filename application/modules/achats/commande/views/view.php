<input type="hidden" value="<?php echo $quote->commande_pourcent_remise; ?>" id="quote_pourcent_remise">
<input type="hidden" value="<?php echo $quote->commande_montant_remise; ?>" id="quote_montant_remise">
<input type="hidden" value="<?php echo $quote->commande_pourcent_acompte; ?>" id="quote_pourcent_acompte">
<input type="hidden" value="<?php echo $quote->commande_montant_acompte; ?>" id="quote_montant_acompte">

<input type="hidden" value="<?php echo $quote->timbre_fiscale; ?>" id="timbre_fiscale">


<input type="hidden" value="<?php echo $quote->commande_item_subtotal; ?>" id="quote_item_subtotal">
<input type="hidden" value="<?php echo $quote->commande_item_tax_total; ?>" id="quote_item_tax_total">
<input type="hidden" value="<?php echo $quote->commande_total; ?>" id="quote_total">
<input type="hidden" value="<?php echo $quote->commande_total_a_payer; ?>" id="quote_total_a_payer">
...
$(function() {
    ...
    $('#btn_save_quote, #btn_save_quote1').click(function() {
        ...
        if (items_count > 0) {
            $.post("<?php echo site_url('commande/ajax/save'); ?>", {
    ...
    $('#btn_generate_pdf').click(function() {
        link = "/commande/generate_pdf/" + $('#quoteidd').val();
    ...
    $('#delete_quote').click(function() {
        linkdel = "/commande/delete/" + $('#quoteidd').val();
        window.open(linkdel);
    });

    // Recupération des ligne devis
    $.post("<?php echo site_url('commande/ajax/getItemsByCommande'); ?>", {
        quote_id: $('#quoteidd').val()
...
<?php
if (($quote->commande_status_id == 4) || ($quote->commande_status_id == 5) || ($quote->commande_status_id == 6)) {
    $ett = 'disabled';
} else {
    $ett = '';
}
		...
		<div class="portlet-header">
			<div class="portlet-title align-items-start flex-column">
                ...
                <input type="hidden" id="quoteidd" value="<?php echo $quote_id; ?>">
					<span class="caption-subject bold med-caption dark"><?php echo lang('bons_commande'); ?> #<?php echo $quote->commande_number; ?></span>
				</div>
			</div>
            ...
            <div class="col-md-8">
				<div class="portlet light formulaire no-padding">
                    ...
                    <div class="row card-row form-row">
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group has-info">
                                ...
                                <input readonly="readonly" id="quote_number" class="form-control form-control-lg form-control-light"
                                    value="<?php echo $quote->commande_number; ?>">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group has-info">
                                ...
                                <input id="quote_nature" class="form-control form-control-lg form-control-light"
                                    <?php echo $ett; ?> value="<?php echo $quote->commande_nature; ?>">
                                <div class="form-control-focus"> </div>
                            </div>
							<div class="separateur" style="margin-bottom: 25px;"></div>
                        </div>
                            ...
                            <div class="form-group has-info">
                                ...
                                <select name="quote_status_id" id="quote_status_id" class="form-control form-control-lg form-control-light">
                                    ...
                                    <option value="<?php echo $key; ?>"
                                        <?php if ($key == $quote->commande_status_id) {?>selected="selected" <?php }?>>
                        ...
                        <?php
$dateAccepte = $quote->commande_date_accepte;
if ($dateAccepte == '') {
    $dateAccepte = date_from_mysql('0000-00-00');
} else {
    $dateAccepte = date_from_mysql($quote->commande_date_accepte);
}
?>
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group has-info">
                                    ...
                                    <div class="">
                                        <select name="quote_delai_paiement" <?php echo $ett; ?>
                                            ...
                                            <option value="<?php echo $delaiPaim->delai_paiement_id; ?>"
                                                <?php if ($delaiPaim->delai_paiement_id == $quote->commande_delai_paiement) {?>selected="selected"
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="form-group has-info">
                                ...
                                <textarea height="40" name="notes" id="notes"
                                    style="width: 100%;padding: 5px 10px;height:80px;" class="form-control"><?php echo $quote->notes; ?></textarea>
                                <div class="form-control-focus"></div>
                            </div>
                            <div style="clear:both"></div>
                    </div>
