		...
		<div class="portlet-header">
			<div class="portlet-title align-items-start flex-column">
				<div class="caption font-dark-sunglo">
					<span class="caption-subject bold med-caption dark"><?php echo lang('bon_livraison'); ?></span><br />
					<span class="caption-subject text-bold small-caption muted"><?php echo lang('add_bl'); ?></span>
				</div>
			</div>
			<div class="portlet-toolbar">
				<div class="pull-right btn-group">
					<a href="#" class="btn btn-success btn-sm blue bg-success text-success" id="btn_save_bl">
						<?php echo lang('save'); ?>
					</a>
				</div>
			</div>
						...
						<div class="col-lg-4 col-sm-4 col-xl-12"> 
                            <div class="form-group has-info">
                                ...
                                <input disabled="disabled" id="quote_number" class="form-control form-control-lg form-control-light"
                                    value="<?php echo $nextcode; ?>" title="<?php echo lang('bl'); ?> ">
                                <div class="form-control-focus"></div>
                            </div>
                        </div>
						<div class="col-lg-4 col-sm-4 col-xl-12"> 
		...
		<div class="portlet-body">
				<div class="row card-row form-row">
					...
					<div class="col-md-12" style="margin-left: 15px; width: 98%;">
                        ...
                        <?php $this->layout->load_view('bl/partial_item_table');?>
                        <div style="clear:both"></div>
                        <br>
                        <div class="form-group has-info">
                            <label for="form_control_1"><?php echo lang('notes'); ?></label>
                            <textarea height="40" name="notes" id="notes" class="form-control"
                                style="width: 100%;padding: 5px 10px;height:80px;"></textarea>
                            <div class="form-control-focus"></div>
                        </div>
                        <div style="clear:both"></div>
                    </div>
...
$('#btn_save_bl, #btn_save_quote2').click(function() {
    var items = [];
    var item_order = 1;
    ...
    $.post("<?php echo site_url('bl/ajax/create'); ?>", {
