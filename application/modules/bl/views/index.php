...
?>
     <table style="width:100%; margin-top: 0px;">
         <tr>
             <td align="left" class="form-widh factures" style="width:22%">
                 ...
                 <form class="navbar-form navbar-left search_in_list" role="search" style="padding:0;">
                     <div class="form-group">
                         <input id="filter_quotes" type="text" class="search-query form-control input-sm" placeholder="<?php echo lang('filtrer_bl'); ?>">
                     </div>
                 </form>
                 <?php }?>
             </td>
...
?>
             ...
             <td align="right" class="pull-block bl" style=" width:52%">
                 ...
                 <div class="pull-right" style="margin:2px 0;">
                   ...
                   <!--  <button style="padding: 3px 10px 5px; background-color: #2EB2E6; color: #fff;" id="group_bl_invoice"
                     ...
                     <a class="create-quote btn btn-sm btn-primary btn-light-success"
                         href="<?php echo base_url(); ?>bl/form">
                         <?php echo lang('create_delivery_form'); ?>
                     </a>
                     <?php }?>
                 </div>
                 <?php }?>
             ...
             <div id="content" class="table-content">
                 ...
                 <div class="table-scrollable" style=" width: 100%; border:none!important;">
                     <table class="table table-striped table-hover table-responsive" id="quote_all">
                         <thead>
                             <tr>
                                 <th width="50" order="ip_bl.bl_number"><?php echo lang('num_devis'); ?></th>
                                 <th width="50" order="ip_bl.bl_status_id" style="text-align:center;">
                                     <?php echo lang('status_tab'); ?></th>
                                 <th width="100" order="ip_bl.quote_date_created"><?php echo lang('created'); ?>
                                 </th>
                                 <th width="100" order="ip_bl.quote_date_expires"><?php echo lang('due_date'); ?>
                                 </th>
                                 ...
                                 <th width="150" order="ip_bl.bl_nature"><?php echo lang('quote_nature'); ?></th>
                                 <th width="100" order="bl_item_subtotal_final"><?php echo lang('amount_ht'); ?></th>
                                 <th width="100" order="bl_total_final"><?php echo lang('amount_ttc'); ?></th>
                                            ...
                                            <li>
                                                 <a href="#">
                                                     <div id="select_all" class="md-checkbox">
                                                         ...
                                                         <label for="aa"><?php echo lang('selected_all'); ?>
                                                             <span></span>
                                                             <span class="check"></span>
                                                             <span class="box"></span>
                                                         </label>
...
$('#export_excel').click(function() {
    ...
    if (long1.length > 0) {
        ...
        $.post("<?php echo site_url('bl/ajax/getAllbl'); ?>", function(data) {
            ...
            window.open("<?php echo site_url('bl/export_excel'); ?>/" + ids_quote_sep,
...
$(function() {
    ...
    function filterQuotes() {
        ...
        $('#filter_results').load("<?php echo site_url('commande/ajax/load_bl_partial_filter'); ?>/" +
            Math
