...
class Mdl_Bl_Tax_Rates extends Response_Model
{
    public $table = 'ip_bl_tax_rates';
    public $primary_key = 'ip_bl_tax_rates.bl_tax_rate_id';
    ...
    public function default_select()
    {
        ...
        $this->db->select('ip_bl_tax_rates.*');
    }

    public function default_join()
    {
        $this->db->join('ip_tax_rates', 'ip_tax_rates.tax_rate_id = ip_bl_tax_rates.tax_rate_id');
    }
