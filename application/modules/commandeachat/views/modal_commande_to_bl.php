...
<script type="text/javascript">
    $(function () {
        ...
        $('#quote_to_bl_confirm').click(function () {
            $.post("<?php echo site_url('commande/ajax/commande_to_bl'); ?>", {
                quote_id: <?php echo $commande_id; ?>,
                ...
                commande_date_accepte : $('#commande_date_accepte').val(),
            ...
            function (data) {
                ...
                if (response.success == '1') {
                    window.location = "<?php echo site_url('bl/view'); ?>/" + response.invoice_id;
                }else {
    ...
    <form class="modal-content">
        <div class="modal-header" style=" height: 50px !important;border-bottom: 1px solid #E5E5E5;width: 41%;">
            ...
            <div class="col-md-10" style=" font-weight: 600;font-size: 18px;margin-bottom: 14px;">
                <?php echo lang('commande_to_bl'); ?>
            </div>
        </div>
        <div class="modal-body" style="margin-top: 7%;">

            <input type="hidden" name="quote_date_accepte" id="quote_date_accepte" value="<?php echo $quote->quote_date_accepte; ?>">
            ...
            <input type="hidden" name="quote_number" id="quote_number" value="<?php echo $quote->commande_number; ?>">
            <input type="hidden" name="user_id" id="user_id" value="<?php echo $quote->user_id; ?>">
            <input type="hidden" name="invoice_terms" id="invoice_terms" value="<?php echo $quote->notes; ?> (créer à partir du commande n°: <?php echo $quote->commande_number; ?>)">
            <input type="hidden" name="nature" id="nature" value="<?php echo $quote->commande_nature; ?>">
            <input type="hidden" name="invoice_delai_paiement" id="invoice_delai_paiement" value="<?php echo $quote->commande_delai_paiement; ?>">
            <input type="hidden" name="bl_pdf" id="bl_pdf" value=" sur commande n°: <?php echo $quote->commande_number; ?>">

            <input type="hidden" name="invoice_group_id" id="invoice_group_id" value="0">
            <input type="hidden" name="invoice_status_id" id="invoice_status_id" value="<?php echo $quote->commande_status_id; ?>">
            ...
            <input type="hidden" name="commande_date_accepte" id="commande_date_accepte" value="<?php echo $quote->commande_date_accepte; ?>">

            <input type="hidden" name="invoice_item_subtotal" id="invoice_item_subtotal" value="<?php echo $quote->commande_item_subtotal; ?>">
            <input type="hidden" name="invoice_item_tax_total" id="invoice_item_tax_total" value="<?php echo $quote->commande_item_tax_total; ?>">
            <input type="hidden" name="invoice_tax_total" id="invoice_tax_total" value="<?php echo $quote->commande_tax_total; ?>">
            <input type="hidden" name="timbre_fiscale" id="timbre_fiscale" value="<?php echo $quote->timbre_fiscale; ?>">
            <input type="hidden" name="invoice_total" id="invoice_total" value="<?php echo $quote->commande_total; ?>">
            <input type="hidden" name="invoice_pourcent_remise" id="invoice_pourcent_remise" value="<?php echo $quote->commande_pourcent_remise; ?>">
            <input type="hidden" name="invoice_montant_remise" id="invoice_montant_remise" value="<?php echo $quote->commande_montant_remise; ?>">
            <input type="hidden" name="invoice_pourcent_acompte" id="invoice_pourcent_acompte" value="<?php echo $quote->commande_pourcent_acompte; ?>">
            <input type="hidden" name="invoice_montant_acompte" id="invoice_montant_acompte" value="<?php echo $quote->commande_montant_acompte; ?>">
            <input type="hidden" name="invoice_item_subtotal_final" id="invoice_item_subtotal_final" value="<?php echo $quote->commande_item_subtotal_final; ?>">
            <input type="hidden" name="invoice_item_tax_total_final" id="invoice_item_tax_total_final" value="<?php echo $quote->commande_item_tax_total_final; ?>">
            <input type="hidden" name="invoice_total_final" id="invoice_total_final" value="<?php echo $quote->commande_total_final; ?>">
            <input type="hidden" name="invoice_total_a_payer" id="invoice_total_a_payer" value="<?php echo $quote->commande_total_a_payer; ?>">
            <div  class="row">
                <div  class="col-md-6">
                    <div class="form-group has-info">
                        <div class="quote-properties has-feedback">
                                <label for="form_control_1"><?php echo lang('bl_date'); ?></label>
                            <div class="input-group">
                                <input name="invoice_date_created" id="invoice_date_created" style="text-align: left;"  class="form-control input-sm form-control-md form-control-light datepicker" value="<?php echo date('d/m/Y'); ?>">
                ...
                <div class="col-md-6">
                    <div class="form-group has-info">
                         <label for="form_control_1"><?php echo lang('invoice_password'); ?></label>
...
?>" style="margin: 0 auto;" autocomplete="off">
        ...
        <div class="modal-footer" >
            <div class="btn-group">
                ...
                <button class="btn btn-success" id="quote_to_bl_confirm" type="button">
