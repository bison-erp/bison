					...
					<div class="portlet light formulaire no-padding first">
						<div class="content-heading">
							<div class="portlet-title left-title">
								<div class="caption font-dark-sunglo">
									<span class="caption-subject bold med-caption dark"><?php echo lang('Fournisseurs'); ?></span>
								</div>
							</div>
						</div>
					<div class="row card-row form-row">
                        <div class="col-lg-12 col-sm-12 col-xl-12 col-langue">
                            <div class="form-group select-search-input has-info col-input-before-langue">
                                ...
                                <input style="width: 100%;" id="client_name" class="form-control form-control-lg form-control-light" readonly="readonly" value="">
								<button id="search_fournisseur" type="button" class="btn btn-success btn-select-client">
					...
					<div class="row card-row form-row">
						...
						<div class="col-lg-4 col-sm-4 col-xl-12"> 
                            <div class="form-group has-info">
                                ...
                                <input id="commande_achat_nature" class="form-control form-control-lg form-control-light" value="">
                                <div class="form-control-focus"></div>
                            </div>
                        </div>
						<div class="col-lg-4 col-sm-4 col-xl-12"> 
                            ...
                            <div class="form-group has-info">
                                <div class="quote-properties has-feedback">
                                    ...
                                    <div class="input-group">
                                        <input name="commande_achat_date_created" id="quote_date_created"
...
$('#search_fournisseur').click(function() {
    if($('#langue').val()){
    $('#modal-placeholder').load("<?php echo site_url('fournisseurs/ajax/modal_fournisseur_commande_lookup'); ?>/" + Math.floor(
        Math.random() * 1000), { 
    });
    }else{
        alert($('#langmsg').val())
...
function f_load() {
    ...
    if ((path[4])) {
        ...
        $('#commande_achat_nature').attr('disabled', false);
      //  $('#quote_date_accepte').attr('disabled', false);
        ...
        $('#commande_achat_nature').attr('disabled', true);
...
$('#btn_save_commande').click(function() {
    var items = [];
    var item_order = 1;
    ...
    //  console.log($('#quote_date_created').val());
    $.post("<?php echo site_url('commandeachat/ajax/create'); ?>", { 
            fournisseur_id: $('#client_id').val(),
          ...
          //  commande_achat_password: $('#quote_password').val(),
           // commande_date_accepte: $('#quote_date_accepte').val(),
            commande_achat_nature: $('#commande_achat_nature').val(),
            commande_achat_delai_paiement: $('#quote_delai_paiement').val(),
            notes: $('#notes').val(),
