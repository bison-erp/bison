...
<form method="post" class="form-horizontal">
   ...
   <!-- <pre>
    <?php
    print_r($this->mdl_users->form_values);
    // print_r($groupes_users);
    foreach ($groupes_users as $groupes_user) {
        print_r($groupes_user);
    }
    ?>
    </pre>-->
    <div id="content">
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo">
                            ...
                            <span class="caption-subject bold uppercase"> <?php echo lang('account_information'); ?></span>
                        </div>
        ...
        <div id="userInfo">
            ...
            <fieldset>
                ...
                <div class="form-group" style=" display:none">
                    ...
                    <div class="col-xs-12 col-sm-6"><input name="user_type" id="user_type" class="form-control" value="1">
<!--                        <select name="user_type" id="user_type" class="form-control">
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-3 text-right text-left-xs">
                        <label class="control-label">
                            <?php echo lang('groupe_user'); ?>
                        </label>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <select name="groupes_user_id" class="input-sm form-control">
                            <option value=""></option>
        ...
        <div>
            <?php echo $this->layout->load_view('layout/header_buttons'); ?><br><br>
        </div>
    </div>
