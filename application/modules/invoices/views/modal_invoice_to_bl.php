...
<script type="text/javascript">
    $(function () {
        ...
        $('#quote_to_bl_confirm').click(function () {
            $.post("<?php echo site_url('invoices/ajax/invoices_to_bl'); ?>", {
                invoice_id: <?php echo $quote_id; ?>,
...
?>
            ...
            <input type="hidden" name="quote_number" id="quote_number" value="<?php echo $quote->invoice_number; ?>">
            <input type="hidden" name="user_id" id="user_id" value="<?php echo $quote->user_id; ?>">
            <input type="hidden" name="invoice_terms" id="invoice_terms" value="<?php echo $quote->invoice_terms; ?> (créer à partir du facture n°: <?php echo $quote->invoice_number; ?>)">
            <input type="hidden" name="nature" id="nature" value="<?php echo $quote->nature; ?>">
            <input type="hidden" name="invoice_delai_paiement" id="invoice_delai_paiement" value="<?php echo $quote->invoice_delai_paiement; ?>">
            <input type="hidden" name="bl_pdf" id="bl_pdf" value=" sur facture n°: <?php echo $quote->invoice_number; ?>">

            <input type="hidden" name="invoice_group_id" id="invoice_group_id" value="0">
            <input type="hidden" name="invoice_status_id" id="invoice_status_id" value="<?php echo $quote->invoice_status_id; ?>">
            <input type="hidden" name="invoice_date_due" id="invoice_date_due" value="<?php echo $quote->invoice_date_due; ?>">
            <input type="hidden" name="invoice_number" id="invoice_number" value="<?php echo $next_id; ?>">

            <input type="hidden" name="invoice_item_subtotal" id="invoice_item_subtotal" value="<?php echo $quote->invoice_item_subtotal; ?>">
            <input type="hidden" name="invoice_item_tax_total" id="invoice_item_tax_total" value="<?php echo $quote->invoice_item_tax_total; ?>">
            <input type="hidden" name="invoice_tax_total" id="invoice_tax_total" value="<?php echo $quote->invoice_tax_total; ?>">
            <input type="hidden" name="timbre_fiscale" id="timbre_fiscale" value="<?php echo $quote->timbre_fiscale; ?>">
            <input type="hidden" name="invoice_total" id="invoice_total" value="<?php echo $quote->invoice_total; ?>">
            <input type="hidden" name="invoice_pourcent_remise" id="invoice_pourcent_remise" value="<?php echo $quote->invoice_pourcent_remise; ?>">
            <input type="hidden" name="invoice_montant_remise" id="invoice_montant_remise" value="<?php echo $quote->invoice_montant_remise; ?>">
            <input type="hidden" name="invoice_pourcent_acompte" id="invoice_pourcent_acompte" value="<?php echo $quote->invoice_pourcent_acompte; ?>">
            <input type="hidden" name="invoice_montant_acompte" id="invoice_montant_acompte" value="<?php echo $quote->invoice_montant_acompte; ?>">
            <input type="hidden" name="invoice_item_subtotal_final" id="invoice_item_subtotal_final" value="<?php echo $quote->invoice_item_subtotal_final; ?>">
            <input type="hidden" name="invoice_item_tax_total_final" id="invoice_item_tax_total_final" value="<?php echo $quote->invoice_item_tax_total_final; ?>">
           <!-- <input type="hidden" name="invoice_total_final" id="invoice_total_final" value="<? //php echo $quote->quote_total_final; ?>">
            ...
            <input type="hidden" name="invoice_total_a_payer" id="invoice_total_a_payer" value="<?php //echo $quote->invoice_total_a_payer; ?>">
            <input type="hidden" name="invoice_balance" id="bl_balance" value="<?php echo $quote->invoice_balance; ?>">
            <div  class="row">
                <div  class="col-md-6">
