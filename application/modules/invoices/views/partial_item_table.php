...
<div class="col-xs-12 col-md-6" id="total_bloc">
    ...
    <div class="col-xs-12 col-md-9">
        <span style="display:none;" class="devise_view view_before"></span>
        <span class="amount" style="display:none;"></span><span style="display:none;"
            id="montant_sous_tot_invoice"></span>
    </div>
    <div class="col-xs-12 col-md-3"></div>
    <div class="col-xs-12 col-md-9">
        <span class="devise_view view_before" style="display:none;"></span> <span style="display:none;"
            class="amount"></span><span style="display:none;" id="tot_tva_invoice"> </span> <span style="display:none;"
...
<th><?php echo lang('description'); ?></th>
<th style="width: 100px;"><?php echo lang('quantity'); ?></th>
<th style="width: 150px;"><?php echo lang('price'); ?> (<span class="devise_view"></span>)</th>
<th style="width: 130px;"><?php echo lang('subtotal'); ?> (<span class="devise_view"></span>)</th>
<th style="width: 110px;"><?php echo lang('tax_rate'); ?></th>
<th style="width: 120px;"><?php echo lang('total'); ?> (<span class="devise_view"></span>)</th>
<th style="width:40px;"></th>
</tr>
</thead>
<tbody class="ui-sortable">
