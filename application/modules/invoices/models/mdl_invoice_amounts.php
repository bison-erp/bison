...
class Mdl_Invoice_Amounts extends CI_Model
{
    ...
    public function calculate_invoice_taxes($invoice_id)
    {
        ...
        if ($invoice_tax_rates) {
            ...
            $invoice_total = $invoice_amount->invoice_item_subtotal + $invoice_amount->invoice_item_tax_total + $invoice_amount->invoice_tax_total + $invoice_amount->timbre_fiscale;;
