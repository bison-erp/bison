...
<div id="headerbar">
    ...
    <div class="pull-right" style="margin: 15px 7px;">
        <a class="btn btn-sm btn-primary btn-light-success" href="<?php echo site_url('categorie_fournisseur/form'); ?>">
            <?php echo lang('create_groupe'); ?>
		</a>
    </div>
	
    <!--div class="pull-right">
        <!--?php echo pager(site_url('categorie_fournisseur/index'), 'mdl_categorie_fournisseur'); ?>
    </div-->
    <?php }?>
            ...
            <div class="portlet light">
                <div class="table-responsive">
                    <table class="table table-striped table-hover" id="fournisseur_cat">
                        ...
                        <tbody>
                            <?php
foreach ($mdl_categorie_fournisseur as $family) {?>
                            <tr class="odd gradeX">
                                <td><?php echo $family->designation; ?></td>
                                <td>
