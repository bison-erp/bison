...
?>
     <table style="width:100%; margin-top: 0;">
         <tr>
             <td  class="form-widh devis" align="left" style=" width:23%">
                 ...
                 <form class="navbar-form navbar-left search_in_list" role="search" style="padding:0;">
                     <div class="form-group">
                         <input id="filter_quotes" type="text"
...
?>
             ...
             <td align="right" class="pull-block" style=" width:41%">
                 ...
                 <div class="pull-right" style="margin:2px 0;">
                     ...
                     <a class="create-quote no-marg btn btn-sm btn-primary btn-light-success"
                         href="<?php echo base_url(); ?>quotes/form">
             ...
             <div id="content" class="table-content">
                 ...
                 <div class="table-scrollable" style=" width: 100%;border:none!important;">
                     <table class="table table-striped table-hover table-responsive" id="quote_all">
                         <thead>
                             <tr>
                                 <th width="50" order="ip_quotes.quote_number"><?php echo lang('num_devis'); ?></th>
                                 <th width="50" order="ip_quotes.quote_status_id" style="text-align:center;">
                                     <?php echo lang('status_tab'); ?></th>
                                 <th width="100" order="ip_quotes.quote_date_created"><?php echo lang('created'); ?>
                                 </th>
                                 <th width="100" order="ip_quotes.quote_date_expires"><?php echo lang('due_date'); ?>
                                 </th>
                                 <th width="180" order="client_societe2"><?php echo lang('client_filter'); ?></th>
                                 <th width="50" order="client_country"><?php echo lang('client_pays'); ?></th>
                                 <th width="180" order="ip_quotes.quote_nature"><?php echo lang('quote_nature'); ?></th>
                                 <th width="100" order="quote_item_subtotal_final"><?php echo lang('amount_ht'); ?></th>
                                 <th width="100" order="quote_total_final"><?php echo lang('amount_ttc'); ?></th>
...
<div class="pag-table-content">
    <div class="pull-right">
        <select class="btn btn-default btn-sm bg-light-primary pagin" id="quotes_par_page">
...
$('#export_excel').click(function() {
    ...
    if (long1.length > 0) {
        ...
        $.post("<?php echo site_url('quotes/ajax/getAllquote'); ?>", function(data) {
          ...
          /* window.open("<?php// echo site_url('quotes/export_excel'); ?>/" + ids_quote_sep,
                ...
                window.open("<?php echo site_url('quotes/export_excelall'); ?>",
                "_blank"); // Opens a new window
        })
...
$(function() {
    ...
    limit_par_page = 20;
    nb_pages = 1;
    order_by = "ip_quotes.quote_number";
    order_method = "desc";
    ...
    function filterQuotes() {
        ...
        $('#filter_results').load("<?php echo site_url('quotes/ajax/load_quotes_partial_filter'); ?>/" +
            Math
