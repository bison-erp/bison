...
class Mdl_Families extends Response_Model
{
    ...
    public function by_families($match)
    {
        $this->db->like('family_name', $match);
    }
    public function by_families_id($match)
    {
        $this->db->like('family_name', $match);
    }

    public function by_id_familie($id)
    {
        $this->filter_where('family_id', $id);
        return $this;
    }
