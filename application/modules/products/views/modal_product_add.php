...
<div id="create-product" class="modal col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" role="dialog"
    ...
    <form class="modal-content" style=" width: 100%" enctype="multipart/form-data">
        <div class="modal-header" style="height: 70px">
            ...
            <h3 style="font-weight: 600;font-size: 18px;margin:0;"><?php echo lang('create_product'); ?></h3>
        </div>
        <input type="hidden" name="langue" id="langue" >
        <div style="clear:both"></div>
        <div class="modal-body" style="margin-top: 70px;max-height: 400px;">
    ...
    foreach ($devises as $value) {
                    ...
                    <!-- fin pricing -->
                        ...
                        <table id="tab_stock">                       
                            ...
                            <tr id="row_add_<?php echo $i ?>">   
                                ...
                                <td><input id="ref<?php echo $i ?>" class="form-control form-control-lg form-control-light" type="text" value="<?php echo $valuestck->ref_stock?>" name="ref[]"/></td>
                                ...
                                <td><input class="form-control form-control-lg form-control-light" type="text" name="quantite_stock[]" id="quantite<?php echo $i ?>" value="<?php echo $valuestck->quantite_stock ?>"/></td>
        ...
        <div class="modal-footer">
            <div class="btn-group">
                ...
                <button class="btn btn-success btn-sm" id="product_create_confirm" type="button" name="btn_submit">
