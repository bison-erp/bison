...
<div id="headerbar">
    ...
    <div class="pull-right" style="margin: 15px 7px;">
        <a class="btn btn-sm btn-primary btn-light-success" href="<?php echo site_url('depot/form'); ?>">
            <?php echo 'Ajouter une dépôt' ?>
		</a>
    </div>
...
<div class="pag-table-content">	
    <div class="pull-right  visible-lg">
        <?php echo pager(site_url('depot/index'), 'mdl_depot'); ?>
    </div>
</div>
	<!-- pagination -->
