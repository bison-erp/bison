...
//                RECUP DERNIER N° FACTURE
            ...
            <input type="hidden" name="invoice_terms" id="invoice_terms" value="<?php echo $quote->notes; ?> (créer à partir du devis n°: <?php echo $quote->quote_number; ?>)">
                ...
                <div  class="col-md-6">
                    ...
                    <div class="form-group has-info">
                        <div class="quote-properties has-feedback">
                                <label for="form_control_1"><?php echo lang('invoice_date'); ?></label>
