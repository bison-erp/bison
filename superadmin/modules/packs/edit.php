...
<input type="hidden" id="pack_id" value="<?php echo $pack['pack_id']; ?>">
            ...
            <div class="col-xs-12 col-md-12">
                <table class="table table-bordered table-condensed no-margin" style="width: 700px;margin: 0 auto;">
                    ...
                    <tbody>
                      <!--  <tr>
                            <td>Nom du pack</td>
                            <td align="center"><input type="text" class="input-sm form-control"
                                    value="<?php // echo $pack['pack_name']; ?>" id="pack_name"></td>
                        </tr>-->
                        <tr>
                            ...
                            <td>
                                <div class="col-md-2" style="line-height: 27px; margin:0;padding:0;width:20px;">
                                    <input type="radio" id="nb_collaborateurs_1" name="nb_collaborateurs" value="0"
                                        class="input-sm form-control" <?php if ($pack['nb_collaborateurs'] == "-1") {
    echo "checked";
}
?>>
                                </div>
...
?>>
                                ...
                                <div class="col-md-4" style="line-height: 27px; margin:0;padding:0;">
                                    <input type="number" <?php if ($pack['nb_collaborateurs'] == "-1") {
    echo "disabled";
} else {
    echo 'value="' . $pack['nb_collaborateurs'] . '"';
}
?> id="nb_collaborateurs_3" class="input-sm form-control" value="0"
                                        style="width: 50px; text-align: left; padding: 0 0px 0 5px;">
                                </div>

                                <td><input type="text"  id="montant_collaborateur" class="input-sm form-control"
                            style="text-align: center; " value="<?php echo $pack['montant_collaborateur'] ?>" ></td>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">Nombre de contacts</td>                            
                            <td><input type="text"  id="montant_contacts"  class="input-sm form-control"
                            style="text-align: center; " value="<?php echo $pack['montant_contacts'] ?>" ></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="col-md-2" style="line-height: 27px; margin:0;padding:0;width:20px;">
                                    <input type="radio" id="nb_factures_mois_1" name="nb_factures_mois" value="0"
                                        class="input-sm form-control" <?php if ($pack['nb_factures_mois'] == "-1") {
    echo "checked";
}
?>>
                                </div>
...
?>>
                                ...
                                <div class="col-md-4" style="line-height: 27px; margin:0;padding:0;">
                                    <input type="number" <?php if ($pack['nb_factures_mois'] == "-1") {
    echo "disabled";
} else {
    echo 'value="' . $pack['nb_factures_mois'] . '"';
}
?> id="nb_factures_mois_3" class="input-sm form-control" value="0"
                                        style="width: 50px; text-align: left; padding: 0 0px 0 5px;">
                                </div>
                            </td>
                            <td><input type="text"  id="montant_factures_mois" class="input-sm form-control"
                            style="text-align: center; " value="<?php echo $pack['montant_factures_mois'] ?>" ></td>
                            </td>
                        </tr>
                            ...
                            <td>
                                <div class="col-md-2" style="line-height: 27px; margin:0;padding:0;width:20px;">
                                    <input type="radio" id="nb_devis_mois_1" name="nb_devis_mois" value="0"
                                        class="input-sm form-control" <?php if ($pack['nb_devis_mois'] == "-1") {
    echo "checked";
}
?>>
                                </div>
...
?>>
                                ...
                                <div class="col-md-4" style="line-height: 27px; margin:0;padding:0;">
                                    <input type="number" <?php if ($pack['nb_devis_mois'] == "-1") {
    echo "disabled";
} else {
    echo 'value="' . $pack['nb_devis_mois'] . '"';
}
?> id="nb_devis_mois_3" class="input-sm form-control" value="0"
                                        style="width: 50px; text-align: left; padding: 0 0px 0 5px;">
                                </div>
                            </td>
                            <td><input type="text"  id="montant_devis_mois" class="input-sm form-control"
                            style="text-align: center; " value="<?php echo $pack['montant_devis_mois'] ?>" ></td>
                            </td>
                        </tr>

                        <tr>
                            <td>Documents multi-devises </td>
                            <td align="center"><input type="checkbox" id="multi_devises" class="input-sm form-control" <?php if ($pack['multi_devises'] == 1) {
    echo "checked";
}
?>></td>
  <td><input type="text"  id="montant_multi_devises" class="input-sm form-control"
                            style="text-align: center; " value="<?php echo $pack['montant_multi_devises'] ?>" ></td>
                            </td>
                        </tr>

                        <tr>
                            <td>Export PDF par lot</td>
                            <td align="center"><input type="checkbox" id="export_lot_pdf" class="input-sm form-control" <?php if ($pack['export_lot_pdf'] == 1) {
    echo "checked";
}
?>></td>
  <td><input type="text"  id="montant_export_lot_pdf" class="input-sm form-control"
                            style="text-align: center; " value="<?php echo $pack['montant_export_lot_pdf'] ?>" ></td>
                            </td>
                        </tr>

                        <tr style="display: none;">
                            <td>Plusieurs établissements</td>
                            <td align="center"><input type="checkbox" id="multi_societes" class="input-sm form-control" <?php if ($pack['multi_societes'] == 1) {
    echo "checked";
}
?>></td>
                        ...
                        <tr>
                            ...
                            <td align="center"><input type="checkbox" id="export_excel" class="input-sm form-control" <?php if ($pack['export_excel'] == 1) {
    echo "checked";
}
?>></td>
  <td><input type="text"  id="montant_export_excel" class="input-sm form-control"
                            style="text-align: center; " value="<?php echo $pack['montant_export_excel'] ?>" ></td>
                            </td>
                        </tr>
                        <tr>
                            <td>Relance automatique </td>
                            <td align="center"><input type="checkbox" id="relance" class="input-sm form-control" <?php if ($pack['relance'] == 1) {
    echo "checked";
}
?>></td>
  <td><input type="text"  id="montant_relance" class="input-sm form-control"
                            style="text-align: center; " value="<?php echo $pack['montant_relance'] ?>" ></td>
                            </td>
                        </tr>
                       <!-- <tr>
                            <td> Export contact </td>
                            <td align="center"><input type="checkbox" id="export_contact" class="input-sm form-control" <?php if ($pack['export_contact'] == 1) {
    echo "checked";
}
?>></td>
 <td><input type="text"  id="montant_export_contact" class="input-sm form-control"
                            style="text-align: center; " value="<?php echo $pack['montant_export_contact'] ?>" ></td>
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="center"><input type="checkbox" id="gestionstock" class="input-sm form-control" <?php if ($pack['gestionstock'] == 1) {
    echo "checked";
}
?>></td>
<td><input type="text"  id="montant_gestionstock" class="input-sm form-control"
                            style="text-align: center; " value="<?php echo $pack['montant_gestionstock'] ?>" ></td>
                            </td>

                        </tr>
                        <tr>
                            <td>Avec signature bison ou sans Signature </td>
                            <td align="center"><input type="checkbox" id="signature" class="input-sm form-control" <?php if ($pack['signature'] == 1) {
    echo "checked";
}
?>></td>
        ...
        <div style="text-align:center; margin-top:20px;">
            ...
            <button class="btn blue" onclick="editPack()"><i class="fa fa-check"></i> Save</button>
        </div>
    </div>
</div>
