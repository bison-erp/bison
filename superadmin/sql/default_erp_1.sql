...
--
-- Client: localhost
-- Généré le: Lun 22 Février 2016 à 08:12
...
INSERT INTO `ip_devises` (`devise_id`, `devise_label`, `devise_symbole`, `taux`) VALUES
(1, 'Dinars', 'DT', 1);
...
(64, 'smtp_username', 'noreply@novatis.tn'),
(65, 'smtp_port', ''),
(66, 'smtp_security', ''),
...
(76, 'invoice_logo', 'logo_novatis32.png'),
(78, 'code_devis_fin', '2342'),
(79, 'smtp_password', 'YaUckTmi3bn77TwlFhRGo0XCE5x3pipGnc0CAzCv0DJxeiBCRLz9wNZNOZPZ8l3X+IS9msneiY3e/wjjJSknvw=='),
(82, 'login_logo', ''),
(83, 'mail_admin', 'anis@novatis.tn'),
(80, 'code_invoice_fin', '8');
...
CREATE TABLE IF NOT EXISTS `ip_societes` (
  ...
  `adresse_societes` text,
  `adresse2_societes` text,
  `code_postal_societes` varchar(200) NOT NULL,
  `code_postal2_societes` varchar(200) DEFAULT NULL,
  `ville_societes` varchar(200) NOT NULL,
  `ville2_societes` varchar(200) DEFAULT NULL,
  `pays_societes` varchar(200) NOT NULL,
  `pays2_societes` text,
  `site_web_societes` varchar(200) NOT NULL,
  `mail_societes` varchar(200) NOT NULL,
  `tel_societes` varchar(200) NOT NULL,
  `tel2_societes` varchar(200) DEFAULT NULL,
...
--
-- Contenu de la table `ip_societes`
--
