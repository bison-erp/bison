...
--
-- Client: localhost
-- Généré le: Mar 07 Mai 2019 à 08:18
-- Version du serveur: 5.5.43
-- Version de PHP: 5.6.34-1~dotdeb+7.1
...
CREATE TABLE IF NOT EXISTS `ip_depense_montant` (
  `id_depense_montant` int(11) NOT NULL AUTO_INCREMENT,
